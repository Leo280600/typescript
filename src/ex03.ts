...
function deleteMember(name: string): boolean {
    ...
    const index = BUS_MEMBERS.findIndex(m => m.nameTH === name || m.nameEN === name);
...
// ลบสมาชิกชื่อ "อลัน พศวีร์ ศรีอรุโณทัย"
const isDeleted = deleteMember("อลัน พศวีร์ ศรีอรุโณทัย");
if (isDeleted) {
    console.log("ลบสมาชิก 'อลัน พศวีร์ ศรีอรุโณทัย' สำเร็จ");
} else {
    console.log("ไม่พบสมาชิก 'อลัน พศวีร์ ศรีอรุโณทัย'");
}